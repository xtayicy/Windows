...
LRESULT CALLBACK WndProc(HWND hwnd,UINT message,WPARAM wParam,LPARAM lParam){
	...
	switch(message){
		case WM_INPUTLANGCHANGE:
			//MessageBox(hwnd,"WM_INPUTLANGCHANGE","titile",0);
			dwCharSet = wParam;
		case WM_CREATE:
			//MessageBox(hwnd,"WM_CREATE","titile",0);
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd){
	...
	hwnd = CreateWindow(szAppName,TEXT("The KeyView2 program"),WS_OVERLAPPEDWINDOW,CW_USEDEFAULT,CW_USEDEFAULT,CW_USEDEFAULT,CW_USEDEFAULT,NULL,NULL,hInstance,NULL);
