...
void Show(HWND hwnd,HDC hdc,int xText,int yText,int iMapMode,TCHAR *szMapMode){
    ...
    TextOut (hdc, xText, yText, szBuffer,
              ...
              rect.left, rect.right, rect.top, rect.bottom)) ;DPtoLP(hdc,(PPOINT)&rect,2);
}
...
int WINAPI WinMain(HINSTANCE hInstance,HINSTANCE hPrevInstance,LPSTR lpCmdLine,int nShowCmd){
	...
	hwnd = CreateWindow(szAppName,TEXT("The WhatSize program"),WS_OVERLAPPEDWINDOW,CW_USEDEFAULT,CW_USEDEFAULT,CW_USEDEFAULT,CW_USEDEFAULT,NULL,NULL,hInstance,NULL);
