	...
	switch(message){
		...
		case WM_COMMAND:
			switch(LOWORD (wParam)){
				case IDC_ONOFF:
					if(hWaveOut == NULL){
						//MessageBox(hwnd,"hWaveOut","tip",0);
						...
						//MessageBox(hwnd,"hWaveOut else","tip",0);
						bShutOff = TRUE ;
		...
		case MM_WOM_OPEN:
			//MessageBox(hwnd,"MM_WOM_OPEN","tip",0);
		...
		case MM_WOM_DONE:
			//MessageBox(hwnd,"MM_WOM_DONE","tip",0);
			if (bShutOff)
			  {
		...
		case MM_WOM_CLOSE:
			//MessageBox(hwnd,"MM_WOM_CLOSE","tip",0);
